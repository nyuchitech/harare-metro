...
-- Add username column for user profiles
-- SQLite doesn't support ADD COLUMN IF NOT EXISTS, so this will fail if column exists
-- This is intentional - run this migration only once
