...
export class ImageService {
   ...
   */
  async getImage(imageUrl: string, options: ImageOptions = {}): Promise<ImageResult> {
   ...
   */
  private async loadImage(imageUrl: string, options: ImageOptions): Promise<ImageResult> {
    // Validate URL
    try {
      new URL(imageUrl);
    } catch {
   ...
   */
  private getOptimizedUrl(imageUrl: string, options: ImageOptions): string {
   ...
   */
  private generateSrcSet(imageUrl: string, options: ImageOptions): string {
   ...
   * Generate cache key
   */
  private getCacheKey(imageUrl: string, options: ImageOptions): string {
 ...
 */
export function useOptimizedImage(imageUrl: string | null, options: ImageOptions = {}) {
